...
class Challenge:
    ...
    def is_supported(self, config: Configuration,
        ...
        try:
            ...
            # Decline casual challenges from bots (only play rated against bots)
            casual_bot = not self.rated and self.challenger.is_bot
            decline_reason = (self.decline_due_to(config.accept_bot or not self.challenger.is_bot, "noBot")
                              ...
                              or self.decline_due_to(not casual_bot, "casual")
